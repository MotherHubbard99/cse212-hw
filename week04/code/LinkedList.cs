...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        //if value is in between the head and the tail
        ...
        while (current.Next != null)
        {
            if (current.Next.Data == value)
            {
                ...
                //get out of the loop after removing the node
                return;
            }
            //go to the next node to look at the value
    ...
    {
        //make sure the head has a value
        if (_head == null)
            return;
        //start looking at the head
        Node current = _head;

        //make sure the current value isn't null
        while (current != null)
        {
